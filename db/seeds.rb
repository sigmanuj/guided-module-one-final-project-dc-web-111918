...
ms_4 = Movie_Source.create(title: "Fast and Furious", provider: )
ms_5 = Movie_Source.create(title: "Fast Five", provider: )
ms_6 = Movie_Source.create(title: "Fast & Furious 6", provider: )
ms_7 = Movie_Source.create(title: "Furious 7", provider: )
ms_8 = Movie_Source.create(title: "The Fate of the Furious", provider: )
ms_9 = Movie_Source.create(title: "Love Actually", provider: )
ms_10 = Movie_Source.create(title: "P.S I Love You", provider: )
ms_11 = Movie_Source.create(title: "Die Hard", provider: )
ms_12 = Movie_Source.create(title: "Die Hard 2", provider: )
